  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[80vh] text-center space-y-12">
      <div className="space-y-6 max-w-3xl">
        <h1 className="text-5xl md:text-7xl font-extrabold tracking-tight bg-clip-text text-transparent bg-gradient-to-br from-foreground to-foreground/60">
          Verify Influence. <br className="hidden md:block"/> Pay for Performance.
        </h1>
      ...
      <div className="w-full max-w-md mx-auto">
        <form onSubmit={handleSubmit} className="relative flex items-center group">
          ...
          <Input 
            ...
            className="w-full pl-11 pr-32 h-14 text-lg rounded-full border-border/60 bg-background/50 backdrop-blur-sm focus-visible:ring-primary shadow-sm transition-all"
            value={handle}
            onChange={(e) => setHandle(e.target.value)}
          />
          <Button 
            type="submit" 
            className="absolute right-1.5 h-11 rounded-full px-5 transition-transform hover:scale-105"
      ...
      <div className="pt-16 grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl text-left border-t border-border/30 w-full opacity-70">
        <div>
